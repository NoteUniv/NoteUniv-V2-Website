                        ...
                        <thead>
                            <tr class="h-12 text-base bg-nu-primary text-white cursor-pointer"
                                ...
                                <th class="font-semibold px-4 w-1/6" :class="{'min-w-[100px]': isOpen}">
                                    {{ __('Student') }}</th>
                                <th class="font-semibold px-4 w-2/6" :class="{'min-w-[250px]': isOpen}">
                                    {{ __('Class') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <table class="w-full border-collapse border-l border-b border-r border-nu-gray-200">
                                        <thead class="w-full">
                                            <tr class="h-12 bg-nu-gray-100 text-sm text-nu-primary">
                                                <th class="font-semibold text-left px-4 w-3/6">{{ __('Work name') }}
                                                </th>
                                                <th class="font-semibold px-4 w-1/6 min-w-[100px]">{{ __('Grade') }}
                                                </th>
