        ...
        <aside
            ...
            @if (Auth::user()->is_admin)
                <a href="{{ route('dashboard-admin') }}"
                    class="bg-nu-primary w-full aspect-square flex items-center justify-center">
            ...
            @if (Auth::user()->is_student)
                ...
                <div class="bg-nu-gray-100 w-full py-4 text-center">
                    ...
                    <div>
                        <span
                            class="text-grade text-2xl">{{ number_format(Auth::user()->overallAverage(), 2) }}</span>
            ...
            <nav class="flex-grow py-10 px-6 text-lg font-medium">
                <ul class="flex flex-col gap-y-8">
                    @if (Auth::user()->is_admin)
                        <!-- Navigation Links -->
                        <li>
                            <x-nav-link href="{{ route('dashboard-admin') }}"
