            ...
            <div>
                <table class="block xl:table w-full overflow-x-auto border-collapse border-l border-b border-r border-nu-gray-200">
                    ...
                    <tbody>
                        ...
                        <?php endfor; ?>
                        <tr class="hidden xl:table-row h-12 text-xl text-nu-primary bg-nu-gray-100 text-center font-bold tracking-widest cursor-pointer transition-colors duration-200 hover:bg-gray-200">
                            <td colspan="5">
                                ...
                            </td>
                        </tr>
                ...
                <div class="xl:hidden h-10 border-l border-b border-r border-nu-gray-200 text-xl text-nu-primary bg-nu-gray-100 text-center font-bold tracking-widest cursor-pointer transition-colors duration-200 hover:bg-gray-200 leading-8">
                    ...
                </div>
            </div>
        </div>
        <div class="self-start flex flex-col md:flex-row xl:flex-col w-full xl:w-auto gap-4 xl:sticky xl:top-4 xl:min-w-[250px]">
