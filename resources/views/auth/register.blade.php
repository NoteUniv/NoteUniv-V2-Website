            ...
            <div class="m-auto flex flex-col items-center gap-y-12 md:gap-y-16 xl:gap-y-10">
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-y-6 bg-white shadow-drop p-6 text-sm w-[90vw] max-w-[450px] xl:min-w-[350px] xl:w-[35vw] xl:max-w-[550px]">
                    ...
                    <div>
                        ...
                        <x-jet-input id="student_id" type="number" name="student_id"
                            :value="old('student_id')" minlength="8" maxlength="8" placeholder="12345678" required
                    ...
                    <div>
                        ...
                        <x-jet-input id="email" type="email" name="email"
                            :value="old('email')" placeholder="{{ __('student@etu.unistra.fr') }}" required
                            class="input py-2 pr-4 outline-2 outline-nu-primary focus:outline placeholder:text-nu-gray-300 rounded-md"/>
                    </div>
                            ...
                            <div class="flex items-center text-xs text-gray-600">
                                ...
                                <div class="ml-2">
                                    ...
                                    'terms_of_service' => '<a target="_blank" href="' . route('terms.show') . '"
                                        class="underline text-gray-600 hover:text-gray-900">' . __('Terms of
                                        Service') . '</a>',
                                    'privacy_policy' => '<a target="_blank" href="' . route('policy.show') . '"
                                        class="underline text-gray-600 hover:text-gray-900">' . __('Privacy
                                        Policy') . '</a>',
                                    ]) !!}
